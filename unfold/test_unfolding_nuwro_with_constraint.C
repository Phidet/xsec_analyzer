...
void test_unfolding_nuwro_with_constraint()
{
    ...
    // std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 0" << std::endl;
    ...
    const std::string respmat_file_name("/uboone/data/users/jdetje/ubcc1pi_univmake/100Percent_10/univmake_output_nuwro_sidband_run1_reduced_21Feb23.root");
    ...
    // Do the systematics calculations in preparation for unfolding
    const auto *syst_ptr = new ConstrainedCalculator(respmat_file_name, "../systcalc_unfold_fd_min.conf");
    ...
    cm2->SaveAs(("plots/plot_slice_entire_corr_nuwro_with_constraint" + postfix + ".pdf").c_str());
    ...
    cm1->SaveAs(("plots/plot_unfolded_slice_entire_corr_nuwro_with_constraint" + postfix + ".pdf").c_str());
    ...
    c_ac->SaveAs(("plots/plot_entire_additional_smearing_matrix_nuwro_with_constraint" + postfix + ".pdf").c_str());
    ...
    std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 2" << std::endl;
    ...
    std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 3" << std::endl;
    ...
    std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 4" << std::endl;
    ...
    c_cv_hist_2d->SaveAs(("plots/entire_cv_hist_2d_nuwro_with_constraint" + postfix + ".pdf").c_str());

    for (size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx)
    {
        // if (sl_idx != 4)
        //     continue; // TODO: remove !!!!!!!!!!!!!!!!!!!!!
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 5" << std::endl;
        const auto &slice = sb.slices_.at(sl_idx);
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 6" << std::endl;
        ...
        c_conf_1->SaveAs(("plots/cv_confusion_matrix_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf").c_str());
        ...
        if(using_fake_data)
        {
            ...
            c_conf_fake->SaveAs(("plots/fake_confusion_matrix_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf").c_str());
        }
        ...
        TColor::CreateGradientColorTable(nColors, stops, red, green, blue, 20);
        c_ac_slice->SaveAs(("plots/additional_smearing_matrix_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf").c_str());
        ...
        c_corr_unf_slice->SaveAs(("plots/unfolded_correlation_matrix_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf").c_str());
        ...
        c_corr_slice->SaveAs(("plots/correlation_matrix_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf").c_str());
        ...
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 7" << std::endl;
        ...
        c1->Update();
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 8" << std::endl;

        std::string out_pdf_name = "plots/plot_unfolded_slice_" + std::string(sl_idx < 10 ? "0" : "") + std::to_string(sl_idx) + "_nuwro_with_constraint" + postfix + ".pdf";
        ...
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 9" << std::endl;
        write_pgfplots_files(output_file_prefix, slice_hist_table, slice_params_table);
        std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 10" << std::endl;
    } // slices
    std::cout << "DEBUG test_unfolding_nuwro_with_constraint - Point 11" << std::endl;
    return 0;
}
...
int main()
{
    ...
    test_unfolding_nuwro_with_constraint();
