...
void FillHistograms(TTree* tree, TH1F* cc0pi_hist, TH1F* cc1pi_hist, const std::string& x_axis_variable1, const std::string& x_axis_variable2, const float runWeight)
{
    ...
    // int nbins = cc0pi_hist_tmp->GetNbinsX();
    // for (int i = 1; i <= nbins; i++)
    // {
    //     double cc0pi_tmp_value = cc0pi_hist_tmp->GetBinContent(i);
    //     double cc0pi_value = cc0pi_hist->GetBinContent(i);
    //     double cc1pi_tmp_value = cc1pi_hist_tmp->GetBinContent(i);
    //     double cc1pi_value = cc1pi_hist->GetBinContent(i);

    //     std::cout << "Bin " << i << ": cc0pi_hist_tmp = " << cc0pi_tmp_value << ", cc0pi_hist = " << cc0pi_value << ", cc1pi_hist_tmp = " << cc1pi_tmp_value << ", cc1pi_hist = " << cc1pi_value << std::endl;
    // }
